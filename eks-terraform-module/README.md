...
*   **AWS ECR (Elastic Container Registry):** A fully-managed Docker container registry that makes it easy to store, manage, and deploy Docker container images. This module provisions one ECR repository.
